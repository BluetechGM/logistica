...
async salvarSolicitacao() {
    ...
    try {
        ...
        // 2️⃣ Insere os produtos na TABELA DE TESTE
        await inserir_produtos_teste.run();

        // 3️⃣ Insere a solicitação na TABELA DE TESTE
        await inserir_solicitacao_teste.run();
